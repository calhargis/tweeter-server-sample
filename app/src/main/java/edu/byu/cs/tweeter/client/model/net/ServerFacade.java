...
public class ServerFacade {
    ...
    private static final String SERVER_URL = "https://9dzbyn07m3.execute-api.us-east-1.amazonaws.com/m3rest";
    ...
    public StoryResponse getStory(GetStoryRequest request, String urlPath)
            throws IOException, TweeterRemoteException {
        return clientCommunicator.doPost(urlPath, request, null, StoryResponse.class);
    }

    public FeedResponse getFeed(GetFeedRequest request, String urlPath)
            throws IOException, TweeterRemoteException {
    ...
    public FollowCountResponse getFollowingCount(GetFollowCountRequest request, String urlPath)
            throws IOException, TweeterRemoteException {
        return clientCommunicator.doPost(urlPath, request, null, FollowCountResponse.class);
    }

    public FollowCountResponse getFollowersCount(GetFollowCountRequest request, String urlPath)
            throws IOException, TweeterRemoteException {
        return clientCommunicator.doPost(urlPath, request, null, FollowCountResponse.class);
    }
